...
class MIDISequencerTrackState : public MIDIProcessor
{
  public:
    ...
    MIDISequencerTrackState( const MIDISequencer *seq_, int trk, MIDISequencerGUIEventNotifier *n );
...
class MIDISequencerState : public MIDIProcessor
{
  public:
    ...
    MIDISequencerState( const MIDISequencer *s, const MIDIMultiTrack *multitrack_, MIDISequencerGUIEventNotifier *n );
...
class MIDISequencer
{
  public:
    ...
    /// the GUI.
    MIDISequencer( const MIDIMultiTrack *m, MIDISequencerGUIEventNotifier *n = 0 );

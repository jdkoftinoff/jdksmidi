...
#ifndef ALSADRIVER_H__9857EC39_234E_411E_9558_EFDA218796AA
#define ALSADRIVER_H__9857EC39_234E_411E_9558_EFDA218796AA
...
class MIDIDriverAlsa : public MIDIDriver
{
  public:
    ...
    {
    } // destructor moved to MIDIDriver.h by NC
    ...
    /// Use StopTimer() after the background processing is completed, to release
    /// resources.
    ...
    /// <i>after</i> the background procedure is done (indicated by
    /// BGThreadStatus::COMPLETED).
    /// If background procedure is still running while StopTimer() is called,
    /// caller gets
    ...
    */
    ...
    enum BGThreadStatus
    {
        RUNNING, ///< Async procedure is running - use WaitTillDone() to wait
        /// for completion

...
//
void MIDIEditTrack::Erase( MIDIClockTime start, MIDIClockTime end, bool jagged, MIDIEditTrackEventMatcher *match )
{
...
//
void MIDIEditTrack::Delete( MIDIClockTime start, MIDIClockTime end, bool jagged, MIDIEditTrackEventMatcher *match )
{

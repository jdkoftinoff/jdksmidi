...
MIDISequencerTrackNotifier::MIDISequencerTrackNotifier( MIDISequencer* seq_,
                                                        int trk,
...
MIDISequencerTrackState::MIDISequencerTrackState( MIDISequencer* seq_,
                                                  int trk,
                                                  MIDISequencerGUIEventNotifier* n )
...
MIDISequencerState::MIDISequencerState( MIDISequencer* s,
                                        MIDIMultiTrack* m,
                                        MIDISequencerGUIEventNotifier* n )
    : notifier( n ),
      multitrack( m ),
...
bool MIDISequencer::GetNextEventTimeMs( float* t )
{
    ...
    if ( f )
    {
        ...
        double clocks_per_sec = ( ( state.track_state[0]->tempobpm *
                                    ( ( ( double ) tempo_scale ) * 0.01 ) * ( 1.0f / 60.0f ) ) *
            ...
            *msg = beat_marker_msg;
            ...
            if ( state.notifier )
            {
                state.notifier->Notify(
                    this,
                    MIDISequencerGUIEvent( MIDISequencerGUIEvent::GROUP_TRANSPORT,
                                           0,
